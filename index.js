...
{
   return ((this % n) + n) % n;
}; // El mod de JS no funciona para numeros negativos...
...
function str2arr(str, w)
{
   for (let i = 0; i < str.length; i++)
   {
      ...
      {
         notify("Dato ingresado invalido: El texto debe estar incluido en el set de caracteres.", 1);
         throw new Error("Dato ingresado invalido: El texto debe estar incluido en el set de caracteres.");
      }
   }
...
function arr2str(arr)
{
   ...
   {
      notify("Dato ingresado invalido: No es una matriz 2x2.", 1);
      throw new Error("Dato ingresado invalido: No es una matriz 2x2.");
   }
   ...
   {
      notify("Dato ingresado invalido: No esta en set de caracteres.", 1);
      throw new Error("Dato ingresado invalido: No esta en set de caracteres.");
   }
...
function modInverse(a, m, x)
{
   if (gcd(a, m) !== 1)
   {
      notify("No hay inversa del modulo: gcd(determinante, m) debe ser 1.", 1);
      throw new Error("No hay inversa del modulo: gcd(determinante, m) debe ser 1.");
   }
   ...
   notify("Inversa del modulo no encontrada: se detuvo en 200.", 1);
   throw new Error("Inversa del modulo no encontrada: se detuvo en 200.");
}
...
function modInverse2x2(arr, m)
{
   ...
   {
      notify("Dato ingresado invalido: Clave debe tener 4 caracteres de longitud.", 1);
      throw new Error("Dato ingresado invalido: Clave debe tener 4 caracteres de longitud.");
   }
...
function decrypt(ciphertext, key)
{
   ...
   console.log("Inversa Matriz Clave:");
   console.log(keyarr);
...
encbtn.onclick = function()
{
   ...
   {
      notify("Ingrese el texto plano.", 1);
   }
   else if (keytxt.length == 0)
   {
      notify("Ingrese la clave.", 1);
   }
   else
   {
...
decbtn.onclick = function()
{
   ...
   {
      notify("Ingrese texto cifrado.", 1);
   }
   else if (keytxt.length == 0)
   {
      notify("Ingrese clave.", 1);
   }
   else
   {
